...
var (
	...
	// Top Bid Stream URLs (SSZ): https://github.com/ultrasoundmoney/docs/blob/main/top-bid-websocket.md
	TopBidStreamURLs = []string{
		"ws://relay-builders-eu.ultrasound.money/ws/v1/top_bid",
		"wss://aestus.live/ws/v1/bids?format=ssz",
	}
)
